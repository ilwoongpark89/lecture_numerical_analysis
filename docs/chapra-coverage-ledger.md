...
- ⬜ 27.3 shooting 법(BVP) — *경계값, 검토*
- ⬜ 27.6 진동 모드 물리도(두 질량-스프링) — *funcplot 모드로 부분 커버*

---
## 남은 ⬜ 요약 (다음 loop 대상)
w3: 3.8 · w4: 5.2, 5.3, 5.8 · w5: 6.8 · w7: 11.5 · w9: 17.2, 17.14 · w11: 22.2 · w12: 23.4/23.6 · w13: 25.16 · w14: 29.4 · w15: 27.3, 27.6
= 약 15개 (대부분 보조/응용 — 핵심 canonical 은 ✅ 완료). *고급/case study 는 ➖ 의도적 제외.*
