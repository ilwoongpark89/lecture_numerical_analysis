...
export const WEEKS: Week[] = [
  { week: 1, title: "수치해석 개요", topic: "Introduction", desc: "수치해석 개론", ready: false,
    chapters: C(1, [[1, "수치해석이란"], [2, "해석해 vs 수치해"], [3, "오차와 근사"], [4, "수치해석 절차"]]) },
  { week: 2, title: "MATLAB 기초", topic: "MATLAB Fundamentals", desc: "MATLAB 환경·문법·시각화", ready: false,
    chapters: C(2, [[1, "환경과 문법"], [2, "벡터·행렬 연산"], [3, "제어 흐름과 함수"], [4, "그래프 시각화"]]) },
  { week: 3, title: "오차", topic: "Errors", desc: "반올림 오차와 절단 오차", ready: false,
  ...
  { week: 9, title: "곡선 적합", topic: "Curve Fitting", desc: "최소자승법과 회귀 분석", ready: false,
    chapters: C(9, [[1, "최소자승 원리"], [2, "선형·다항 회귀"], [3, "비선형 선형화"], [4, "결정계수 R²"]]) },
  { week: 10, title: "보간법", topic: "Interpolation", desc: "Lagrange·Newton·Spline 보간", ready: false,
