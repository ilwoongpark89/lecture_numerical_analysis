    ...
    <main className="min-h-screen bg-slate-950">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800">
        <div className="container mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <span className="text-sm text-gray-500">Week 3 — Errors</span>
        </div>
      </nav>
      ...
      <div className="pt-14">
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-slate-950">
          <div className="absolute inset-0 z-[1]">
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-amber-500/15 rounded-full blur-3xl opacity-60 translate-x-1/3 -translate-y-1/3" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-orange-600/15 rounded-full blur-3xl opacity-60 -translate-x-1/3 translate-y-1/3" />
          </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">
                Week 4: <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Root Finding</span>
              </h3>
              <p className="text-gray-400 mb-8 max-w-xl mx-auto">
                방정식의 근을 수치적으로 찾는 방법을 배웁니다
              </p>
            </motion.div>
          </div>
        </section>
